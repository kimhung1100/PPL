...
class MT22Visitor(ParseTreeVisitor):
    ...
    # Visit a parse tree produced by MT22Parser#typedecl.
    def visitTypedecl(self, ctx:MT22Parser.TypedeclContext):
        return self.visitChildren(ctx)
    ...
    # Visit a parse tree produced by MT22Parser#scalar_assign_statement.
    def visitScalar_assign_statement(self, ctx:MT22Parser.Scalar_assign_statementContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by MT22Parser#index_operator_statement.
    def visitIndex_operator_statement(self, ctx:MT22Parser.Index_operator_statementContext):
        return self.visitChildren(ctx)
